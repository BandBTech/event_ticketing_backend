...
// func (bs *BillService) UpdatePaymentBill(billID uuid.UUID, req models.UpdatePaymentBillRequest) (*models.PaymentBillResponse, error) {
...
// 			paymentBill.PaidDate = &time.Time{}
// 			*paymentBill.PaidDate = time.Now()
// 		} else {
...
// 		if err := bs.db.Create(paymentHistory).Error; err != nil {
// 			return nil, utils.NewDatabaseError("Failed to create payment history.", err)
// 		}

// 		// Log audit for payment
// 		bs.logAudit(context.Background(), "payment_made", "payment_bill", billID, req.ProcessedBy, "admin", &paymentBill.EventID, map[string]interface{}{
...
// 				return nil, utils.NewValidationError("Cannot cancel a bill that has payments", nil)
// 			}
// 			paymentBill.CancelledDate = &time.Time{}
// 			*paymentBill.CancelledDate = time.Now()
// 		case "paid":
// 			if paymentBill.RemainingAmount > 0 {
// 				return nil, utils.NewValidationError("Cannot mark as paid when there is remaining amount", nil)
// 			}
...
// 		// Log status change
// 		bs.logAudit(context.Background(), "bill_status_changed", "payment_bill", billID, req.ProcessedBy, "admin", &paymentBill.EventID, map[string]interface{}{
...
// 	if err := bs.db.Save(&paymentBill).Error; err != nil {
...
// 	// Validate payment amount
// 	if payment.PaymentAmount > paymentBill.RemainingAmount {
// 		return nil, utils.NewValidationError("Payment amount cannot exceed remaining amount", nil)
// 	}

// 	// Set bill ID for the payment
// 	payment.BillID = billID

// 	// Create payment history record
// 	if err := bs.db.Create(payment).Error; err != nil {
// 		return nil, utils.NewDatabaseError("Failed to create payment history.", err)
// 	}

// 	// Update bill amounts
// 	paymentBill.PaidAmount += payment.PaymentAmount
// 	paymentBill.RemainingAmount -= payment.PaymentAmount
...
// 	// Log audit for payment
// 	bs.logAudit(context.Background(), "payment_added", "payment_bill", billID, payment.ProcessedBy, "admin", &paymentBill.EventID, map[string]interface{}{

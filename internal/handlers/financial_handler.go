...
// 			CASE WHEN transactions.user_id IS NOT NULL THEN users.email ELSE NULL END as user_email,
...
// 			CASE WHEN transactions.guest_user_id IS NOT NULL THEN guest_users.email ELSE NULL END as guest_user_email,
...
// 	} else if transaction.ActorType == "guest" {
// 		userInfo.ID = transaction.actorID

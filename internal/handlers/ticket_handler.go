...
// func NewTicketHandler(ticketService *services.TicketService, refundService *services.RefundService, cfg *config.Config, secureQRService *services.SecureQRService) *TicketHandler {
...
// 	intents, total, err := h.refundService.GetPaymentIntents(status, paymentGateway, eventID, pagination.Page, pagination.Limit, sortBy, sortOrder)
// 	if err != nil {
// 		utils.HandleError(c, err)
// 		return
// 	}

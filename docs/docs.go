...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.CompanyInfoResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.EventCancellationRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/admin/events/{id}/featured": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "Event featured status updated",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
        ...
        "/api/v1/admin/list-all": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of guest users",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/handlers.MinimalGuestUserResponse"
                                            }
                                        }
                                    }
                                }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.OrganizerApprovalRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/admin/otp/status": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "OTP type (registration, password_reset, etc.)",
                        "name": "otp_type",
                        "in": "query",
                        "required": true
                    }
        ...
        "/api/v1/admin/payments/refunds/{refund_id}/approve": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/admin/payments/refunds/{refund_id}/reject": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.PayoutRequestUpdate"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/admin/permissions/initialize-roles": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/admin/permissions/initialize-system": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/admin/users": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by role (user, organizer, subadmin, admin)",
                        "name": "role",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by organizer status (pending, approved, rejected)",
                        "name": "org_status",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        "type": "string",
                        "default": "\"-created_at\"",
                        "description": "Sort by field with optional '-' prefix for desc (e.g., '-created_at', 'name', 'email', 'role', 'account_status')",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "default": "created_at",
                        "description": "Sort by field (created_at, name, email, role, account_status)",
                        "name": "sort_by",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.BulkUserActionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.PromoteUserRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateAccountStatusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/auth/admin/reset-password": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Password reset request with OTP verification",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/auth/admin/reset-password-request": {
            "post": {
        ...
        "/api/v1/auth/organizer/register": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Organizer registration data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.OrganizerRegistrationRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/auth/organizer/reset-password": {
            "post": {
        ...
        "/api/v1/auth/organizer/reset-password-request": {
            "post": {
        ...
        "/api/v1/auth/organizer/send-otp": {
            "post": {
        ...
        "/api/v1/auth/user/reset-password-request": {
            "post": {
        ...
        "/api/v1/organizer/events/tier-templates": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/models.OrganizerTierTemplateResponse"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateOrganizerTierTemplateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/organizer/events/tier-templates/{templateId}": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateOrganizerTierTemplateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/organizer/events/{id}/analytics": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/organizer/events/{id}/sales/control": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Sales control request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.EventSalesControlRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/organizer/events/{id}/tickets": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/organizer/events/{id}/tickets/stats": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.PayoutRequestCreate"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.OrganizerOnboardingStatusResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.TicketCheckInRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/organizer/tickets/checkout": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.TicketCheckOutRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/organizer/tickets/scan": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Ticket scan details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/organizer/tickets/validate-checkin": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Check-in validation details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/organizer/tickets/validate-checkout": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "Check-out validation details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/organizer/users/{user_id}": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/public/events": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "default": "\"featured_first_alpha\"",
                        "description": "Sort parameter (currently fixed to show featured events first in alphabetical order, then non-featured events in alphabetical order)",
                        "name": "sort",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/public/events/category/{category}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Limit number of events (default 10, max 50)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "Events by category with pagination",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
        ...
        "/api/v1/public/events/featured": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Limit number of events (default 3, max 10)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/public/events/upcoming": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Upcoming events with pagination",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.GuestPurchaseRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/public/tickets/validate-token": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "JWT ticket access token",
                        "name": "token",
                        "in": "query",
                        "required": true
                    }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.OrderViewResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/user/payments/check-refund-eligibility": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.TicketPurchaseRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handlers.MinimalGuestUserResponse": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "models.BulkUserActionRequest": {
            ...
            "properties": {
                ...
                "role": {
                    "description": "Required for promote action",
                    "type": "string"
                },
                "user_ids": {
                    "type": "array",
        ...
        "models.CreateOrganizerTierTemplateRequest": {
            "type": "object",
            "required": [
                "template_name"
            ],
        ...
        "models.EventAnalyticsResponse": {
            ...
            "properties": {
                ...
                "tiers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.EventTierAnalytics"
                    }
                },
                "total_revenue": {
                    "type": "number"
        ...
        "models.EventPublicResponse": {
            ...
            "properties": {
                ...
                "tiers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.EventTierPublicResponse"
                    }
                },
                "timezone": {
                    "type": "string"
        ...
        "models.EventTier": {
            ...
            "properties": {
                ...
                "sort_order": {
                    "description": "For ordering tiers",
                    "type": "integer"
                },
                "tier_name": {
                    "type": "string"
        ...
        "models.EventTierPublicResponse": {
            "type": "object",
            "properties": {
                "available": {
                    "type": "integer"
        ...
        "models.OrderViewResponse": {
            ...
            "properties": {
                ...
                "tickets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.TicketViewResponse"
                    }
                },
                "total_amount": {
                    "type": "number"
        ...
        "models.OrganizerRegistrationRequest": {
            "type": "object",
            "required": [
                "email",
                "first_name",
        ...
        "models.OrganizerTierTemplateResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "models.TransactionPaymentDetailsEventSummary": {
            "type": "object",
            "properties": {
                "banner": {
                    "type": "string"
        ...
        "models.TransactionPaymentDetailsResponse": {
            ...
            "properties": {
                "payment_intent": {
                    "$ref": "#/definitions/models.TransactionPaymentIntentSummary"
                },
                "tickets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.TransactionPaymentDetailsTicketSummary"
                    }
                },
                "transaction": {
                    "$ref": "#/definitions/models.TransactionPaymentDetailsTransactionSummary"
                }
            }
        },
        "models.TransactionPaymentDetailsTicketSummary": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
                ...
                "tier": {
                    "$ref": "#/definitions/models.TransactionPaymentDetailsTicketTierSummary"
                },
                "total_amount": {
                    "type": "number"
                },
                ...
                "user": {
                    "$ref": "#/definitions/models.TransactionPaymentDetailsTicketUserSummary"
                }
            }
        },
        "models.TransactionPaymentDetailsTicketTierSummary": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
        ...
        "models.TransactionPaymentDetailsTicketUserSummary": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "models.TransactionPaymentDetailsTransactionSummary": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "number"
                ...
                "event": {
                    "$ref": "#/definitions/models.TransactionPaymentDetailsEventSummary"
                },
                "id": {
                    "type": "string"
                },
                ...
                "user": {
                    "$ref": "#/definitions/models.TransactionPaymentDetailsUserSummary"
                }
            }
        },
        "models.TransactionPaymentDetailsUserSummary": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "models.TransactionPaymentIntentSummary": {
            "type": "object",
            "properties": {
                "card_brand": {
                    "type": "string"
